...
const TEMPLATE_REPLACEMENTS: Record<TemplateChoice, ReplacementGroup[]> = {
  ...
  pest: [
    ...
    { section: "Services", fields: ["Pest categories with descriptions", "Service card images"] },
    { section: "Editorial", fields: ["Feature photo (gallery[0])", "Trust copy"] },
    { section: "Recent jobs", fields: ["Up to 6 service-call photos in 6-up grid"] },
